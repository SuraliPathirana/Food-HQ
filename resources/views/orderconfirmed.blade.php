...
<section class="book-table section bg-light" style="height: 100vh">
            ...
            <div class="sec-wp">
                <div class="container" style="margin:auto;padding: 70px 0px;">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="sec-title text-center mb-5" >
                                
                                <p class="sec-sub-title mb-3">Confirmed</p> 
                                    <div style="padding: 20px 0px">
                                        <h2 class="h2-title" >Your Order is being prepared!
                                        <br>A waiter will serve your food to  the table .Enjoy your time at FOODHQ and leave us a feedback!</h2>
                                    ...
                                    <a type="button" class="btn btn-secondary btn-lg" href="{{url('/feedback',$orderid)}}">Give feedback</a>
